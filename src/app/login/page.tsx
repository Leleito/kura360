    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-[#0F2A44] p-12 text-white">
        ...
        <p className="text-xs text-blue-200/40">
          &copy; {new Date().getFullYear()} Laitigo Labs. All rights reserved.
        </p>
      </div>
                ...
                <div className="mt-8 space-y-6">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span className="bg-white px-4 text-[#A0AEC0]">
                        or continue with
                      </span>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="flex w-full items-center justify-center gap-3 rounded-[8px] border border-[#E2E8F0] bg-white px-4 py-3 text-base font-medium text-[#4A5568] transition-colors hover:bg-[#F7F9FC] focus:outline-none focus:ring-2 focus:ring-[#2E75B6]/20 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                  >
